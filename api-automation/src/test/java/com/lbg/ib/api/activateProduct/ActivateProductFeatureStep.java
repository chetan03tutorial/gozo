...
public class ActivateProductFeatureStep extends BaseEnvSetUp {
	...
	public ActivateProductFeatureStep() throws Exception {
		super();
	...
	public void verifyErrorcode(String msg) {
		String messageBody = activateResponseMap.get("StatusMessage");
