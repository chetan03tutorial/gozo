...
public class E169FeatureStep extends BaseFeatures {
	...
	@Given("^then hit the overdraft create service \"([^\"]*)\" with \"([^\"]*)\" for brand \"([^\"]*)\"$")
	...
	@Given("^validate the hasOdIssued as \"([^\"]*)\"$")
	public void validate_the_currency_code_as(String hasOdIssued) throws Throwable {
	    assertEquals(hasOdIssued, response.getPropValue("hasOdIssued").toString());
	}
