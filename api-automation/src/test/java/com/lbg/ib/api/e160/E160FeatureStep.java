...
public class E160FeatureStep extends BaseFeatures {
	...
	@Given("^then hit the overdraft remove service \"([^\"]*)\" with \"([^\"]*)\" for brand \"([^\"]*)\"$")
	...
	@Given("^validate the currency code as \"([^\"]*)\"$")
	public void validate_the_currency_code_as(String currencyCode) throws Throwable {
	    assertEquals(currencyCode, (String)response.getPropValue("currencyCode"));
	}
