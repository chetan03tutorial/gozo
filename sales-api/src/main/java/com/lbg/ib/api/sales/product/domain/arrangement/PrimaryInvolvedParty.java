...
import com.lbg.ib.api.sales.utils.JsonDateSerializer;

@Validate
@SectionTypeValidation(sectionType = SectionType.PERSONAL_DETAILS)
public class PrimaryInvolvedParty {
    ...
    @OptionalFieldValidation(values = { NEW_PARTYB, EXISTING_PARTYB })
    ...
    @OptionalFieldValidation(values = { BRANCH, EXISTING_PARTYB })
    ...
    private boolean                   isExistingIBRegistered;

    private boolean                   isJoint;

    /**
     * List to store the marketing preferences
     */
    ...
    public PrimaryInvolvedParty() {/* jackson */
    }
    ...
    public PrimaryInvolvedParty(SwitchOptions intendSwitch, Boolean intendOverDraft, Integer intendOdAmount,
            ...
            Integer prevBankYear, Integer prevBankMonth, List<MarketingPreference> marketingPreferences,String overDraftLimit) {
        this.intendSwitch = intendSwitch;
        this.intendOverDraft = intendOverDraft;
        this.intendOdAmount = intendOdAmount;
        this.title = title;
    ...
    public void setMarketingPreferences(List<MarketingPreference> marketingPreferences) {
        this.marketingPreferences = marketingPreferences;
    }

    /**
     * @return the isExistingIBRegistered
     */
    public boolean getIsExistingIBRegistered() {
        return isExistingIBRegistered;
    }

    /**
     * @param isExistingIBRegistered the isExistingIBRegistered to set
     */
    public void setIsExistingIBRegistered(boolean isExistingIBRegistered) {
        this.isExistingIBRegistered = isExistingIBRegistered;
    }
